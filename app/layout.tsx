...
export const metadata: Metadata = {
  ...
  description: 'Join the waitlist for BellyBento - connecting you with trusted tiffin providers in your area. Fresh, homemade meals delivered to your doorstep daily across India.',
  keywords: ['tiffin service', 'homemade food', 'food delivery', 'daily meals', 'tiffin provider', 'tiffin near me', 'home cooked meals', 'dabba service', 'meal subscription', 'ghar ka khana', 'tiffin service india', 'homemade tiffin delivery'],
